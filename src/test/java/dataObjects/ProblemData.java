...
public class ProblemData extends dataUtil{
    ...
    public ProblemTaskData taskData1 = new ProblemTaskData();
    public ProblemTaskData taskData2 = new ProblemTaskData();
    public ProblemTaskData taskData3 = new ProblemTaskData();
